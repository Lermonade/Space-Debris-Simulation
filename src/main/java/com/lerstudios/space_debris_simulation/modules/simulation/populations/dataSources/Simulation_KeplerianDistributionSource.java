...
public class Simulation_KeplerianDistributionSource implements Simulation_OrbitDataSource {
    String name;
    KeplerianDistributionSource source;

    private static final Random RANDOM = new Random();

    public Simulation_KeplerianDistributionSource() {

    }

    public Simulation_KeplerianDistributionSource(String name, KeplerianDistributionSource source) {
        this.name = name;
        this.source = source;
    }
